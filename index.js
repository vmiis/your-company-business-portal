...
$vm.module_links=[
    ...
    "mep|apps/medical-practitioner/index.json",
    "w01|apps/website-template-001/index.json",
    "w02|apps/website-template-002/index.json",
    "w03|apps/website-template-003/index.json",
    "w04|apps/website-template-004/index.json",
    "rpc|apps/reporting-central/index.json",
    "clt|apps/clinical-trials-001/index.json",
    "cto|apps/clinical-trials-001-online-questionnaire/index.json",
    "pvb|apps/clinical-trials-participant-visit-booking/index.json",
    "cbe|apps/crc-stream-b-extension/index.json",
    "bkk|apps/bookkeeping/index.json",
    "cab|apps/car-booking/index.json",
    "dbm|apps/distributed-modules/index.json",
    "dct|apps/document-collaboration-tracking/index.json",
    "eai|apps/education-and-immigration/index.json",
    "enq|apps/enquiry/index.json",
    "eqb|apps/equipment-booking/index.json",
    "inr|apps/incident-reporting/index.json",
    "inv|apps/invoice/index.json",
    "ppm|apps/program-and-project-management/index.json",
    "por|apps/purchase-order-request/index.json",
    "rmb|apps/room-booking/index.json",
