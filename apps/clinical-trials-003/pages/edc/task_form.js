...
$('#F__ID').submit(function(event){
	...
	$VmAPI.request({data:req,callback:function(res){
		...
		else if($vm.vm['__ID'].input!=undefined && $vm.vm['__ID'].input.goback!=undefined){ window.history.go(-1); return; }
		else if($vm.vm['__ID'].op.input!=undefined && $vm.vm['__ID'].op.input.goback!=undefined){ window.history.go(-1); return; }
